  ...
  return (
    <header>
      ...
      <div className='navigation'>
          <ul>
               <li>
                    <Link to='/recently-viewed' className='link'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="pointer-events-none max-h-full max-w-full"><g fill="currentColor"><path d="M13.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0V13h3.5a.5.5 0 010 1z"></path><path d="M2.25 13.66l3.5 4a1 1 0 001.5 0l3.5-4A1 1 0 0010 12H7a7 7 0 117 7 .5.5 0 000 1 8 8 0 10-8-8H3a1 1 0 00-.75 1.66zM3 13h7l-3.5 4z"></path><path d="M13.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0V13h3.5a.5.5 0 010 1z"></path></g></svg>
